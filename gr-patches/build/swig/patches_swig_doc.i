...
%feature("docstring") gr::patches::quadrature_demod "<+description of block+>"

%feature("docstring") gr::patches::quadrature_demod::make "Return a shared_ptr to a new instance of patches::quadrature_demod.

To avoid accidental use of raw pointers, patches::quadrature_demod's constructor is in a private implementation class. patches::quadrature_demod::make is the public interface for creating new instances.

Params: (gain)"

%feature("docstring") gr::patches::quadrature_demod::set_gain "

Params: (gain)"

%feature("docstring") gr::patches::quadrature_demod::gain "
